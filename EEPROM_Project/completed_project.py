...
def delete_string(start_address, length):
    if start_address < 0 or start_address + length > EEPROM_SIZE:
        print("Address or length out of range!")
        return
