...
# Integrated Demo with Logging, Automatic Test Run, String Separator Fix, Delete & Reset Options
...
def reset_log():
    """Reset the log file with confirmation."""
...
def reset_eeprom():
    """Reset the entire EEPROM to 0xFF with confirmation, preserving default text."""
